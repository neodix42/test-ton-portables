...
timeout 180 java -jar /app/MyLocalTon.jar nogui debug test-binaries

rm -rf /app/myLocalTon

timeout 180 java -jar /app/MyLocalTon.jar custom-binaries=/app/bins nogui debug test-binaries
